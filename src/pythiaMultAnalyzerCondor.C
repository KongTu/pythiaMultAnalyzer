...
void pythiaMultAnalyzerCondor(int nEvents, TString inputFilename, TString outputFilename ){
	...
	tree->Add("/gpfs/mnt/gpfs02/eic/ztu/condor/job2/output/"+inputFilename);
	...
	outfilename = "_pythia_multiplicity.root";
   	...
   	TFile output("../rootfiles/"+outputFilename+outfilename,"RECREATE");
   	for(int j = 0; j < 20; j++){
